                ...
                <div className="relative z-10 text-white space-y-12 max-w-lg">
                    <div className="space-y-6">
                        <div className="inline-flex items-center gap-2 bg-zinc-800/50 border border-zinc-700 rounded-full px-4 py-1">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-300">Join 10k+ Creators</span>
                        </div>
                    ...
                    <div className="flex items-center gap-8 border-t border-zinc-800 pt-8">
                        <div>
                            ...
                            <div className="text-[10px] font-black uppercase tracking-widest text-zinc-500">Monthly Reads</div>
                        </div>
                        <div className="h-8 w-px bg-zinc-800" />
                        <div>
                            <div className="text-3xl font-black">100+</div>
                            <div className="text-[10px] font-black uppercase tracking-widest text-zinc-500">Countries</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-col justify-center px-8 lg:px-20 bg-white">
                <div className="max-w-md w-full mx-auto space-y-10">
                    <div className="space-y-4">
                        ...
                        <h1 className="text-4xl font-black text-black tracking-tight">Create your home.</h1>
                        <p className="text-zinc-500 font-medium italic">Beautifully simple, powerfully functional.</p>
                    </div>
                    ...
                    <p className="text-center text-sm font-medium text-zinc-500 italic">
                        ...
                        <Link href="/auth/login" className="text-black font-black not-italic underline underline-offset-4 decoration-2">Login</Link>
                    </p>
                </div>
            </div>
        </div>
